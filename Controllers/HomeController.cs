        ...
        var recentActivities = _context.ProposalLogs
            ...
            .Select(x => new DashboardActivity
            {
                Description = x.Action switch
                {
                    ...
                    "approve" => $"Proposal #{x.ProposalId}, <strong>'{x.Title}'</strong> was granted <span style='color:rgb(6, 55, 103);'>Committee Approval</span> from {x.UserName}",
                    ...
                    "marked_complete"   => $"Proposal #{x.ProposalId}, <strong>'{x.Title}'</strong> was <span style='color:rgb(38, 99, 103);'>Marked Complete</span> by {x.UserName}",
                    "commenced"         => $"Proposal #{x.ProposalId}, <strong>'{x.Title}'</strong> was set to <span style='color:rgb(89, 108, 230);'>Commence</span> by {x.UserName}",
